...
DEFAULT_RULES = [
    Rule("Temperature", SensorType.TEMPERATURE, "zone_air",
    ...
    Rule("Light", SensorType.LIGHT_INTENSITY, "zone_air",
         warning_low=500.0, warning_high=80000.0, critical_low=100.0, critical_high=100000.0),
